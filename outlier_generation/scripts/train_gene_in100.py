...
traindir = os.path.join('/nobackup/dataset/IN100_new/', 'train')
valdir = os.path.join('/nobackup/dataset/IN100_new/', 'val')
...
if args.deepaugment:
    edsr_dataset = torchvision.datasets.ImageFolder(
        '/nobackup-fast/dataset/deepaugment/imagenet-r/DeepAugment/EDSR/',
        trn.Compose([
            trn.RandomResizedCrop(224),
            trn.RandomHorizontalFlip(),
            trn.ToTensor(),
    ...
    cae_dataset = torchvision.datasets.ImageFolder(
        '/nobackup-fast/dataset/deepaugment/imagenet-r/DeepAugment/CAE/',
        trn.Compose([
            trn.RandomResizedCrop(224),
            trn.RandomHorizontalFlip(),
            trn.ToTensor(),
...
ood_data = dset.ImageFolder(root=prefix + "sd/txt2img-samples-in100/"  + args.my_info + '/samples',
...
if args.augmix:
    ood_data = dset.ImageFolder(
        root=prefix + "sd/txt2img-samples-in100/" + args.my_info + '/samples',
