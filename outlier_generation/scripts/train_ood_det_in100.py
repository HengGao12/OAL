...
traindir = os.path.join('/nobackup-slow/dataset/IN100_new/', 'train')
valdir = os.path.join('/nobackup-slow/dataset/IN100_new/', 'val')
...
ood_data = dset.ImageFolder(root="/nobackup-fast/dataset/sd/txt2img-samples-in100/"  + args.my_info + '/samples',
