...
if 'cifar100_' in args.method_name:
    test_data = dset.CIFAR100('/nobackup/cifarpy', train=False, transform=test_transform)
    train_data = dset.CIFAR100('/nobackup/cifarpy', train=True, transform=test_transform)
    num_classes = 100
else:
    ...
    test_data = \
        torchvision.datasets.ImageFolder(
            os.path.join('/nobackup/dataset/IN100_new/', 'val'),
            trn.Compose([
                trn.Resize(256),
                trn.CenterCrop(224),
                trn.ToTensor(),
    ...
    train_data = \
        torchvision.datasets.ImageFolder(
            os.path.join('/nobackup/dataset/IN100_nwe/', 'train'),
            trn.Compose([
                trn.Resize(256),
                trn.CenterCrop(224),
                trn.ToTensor(),
...
if 1:
    ood_data = dset.ImageFolder(root="/nobackup/sd/txt2img-samples-cifar100/txt2img-samples_select_50_sigma_0.07/",
    ...
    # import shutil
    # ood_data = dset.ImageFolder(root="/nobackup/sd/txt2img-samples-in100/gaussian_0.6",
    ...
    ood_data = dset.ImageFolder(root="/nobackup-slow/dataset/sd/txt2img-samples-in100/gaussian_0.3/",
                                transform=trn.Compose([
        trn.Resize(256),
        trn.CenterCrop(224),
        trn.ToTensor(),
    ...
    #                          std=[0.229, 0.224, 0.225]),
    # ]))
    # ood_data = dset.ImageFolder(root="/nobackup-slow/dataset/sd/txt2img-samples-in100/gaussian_0.6",
    #                             transform=trn.Compose([trn.Resize(256),
    #                                                    trn.CenterCrop(224),
    #                                                    trn.ToTensor(),
    #                                                    normalize]))
