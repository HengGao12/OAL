...
all_classes = ['n01498041', 'n01514859', 'n01582220', 'n01608432', 'n01616318',
...
'''
all_classes = ['butterfly', 'rose', 'wolf', 'flatfish', 'cattle', 'rabbit', 'sea', 'skunk', 'couch', 'bridge', 'mushroom', 'lawn_mower', 'bee', 'whale', 'trout', 'shrew', 'sunflower', 'lizard', 'house', 'aquarium_fish', 'telephone', 'caterpillar', 'possum', 'lion', 'pine_tree', 'man', 'wardrobe', 'woman', 'boy', 'lobster', 'leopard', 'mountain', 'television', 'worm', 'crocodile', 'squirrel', 'raccoon', 'cup', 'cockroach', 'maple_tree', 'bowl', 'ray', 'willow_tree', 'cloud', 'plain', 'castle', 'beaver', 'camel', 'kangaroo', 'seal', 'beetle', 'baby', 'train', 'poppy', 'motorcycle', 'tulip', 'shark', 'dolphin', 'orchid', 'mouse', 'fox', 'turtle', 'orange', 'bicycle', 'snail', 'oak_tree', 'clock', 'spider', 'tank', 'apple', 'girl', 'palm_tree', 'rocket', 'bed', 'dinosaur', 'bottle', 'sweet_pepper', 'pear', 'porcupine', 'pickup_truck', 'lamp', 'hamster', 'table', 'plate', 'tractor', 'tiger', 'otter', 'chimpanzee', 'streetcar', 'bus', 'skyscraper', 'crab', 'road', 'keyboard', 'can', 'snake', 'forest', 'chair', 'bear', 'elephant']
...
class FolderWithPath(ImageNetSubsetDataset):
    ...
    def __getitem__(self, index):
        ...
        save_path = './EDSR_c100/' + self.idx_to_class[target]
...
distorted_dataset = FolderWithPath(
    root="/nobackup/dataset/CIFAR100/TRAIN/", transform=test_transform)

distorted_dataset[0]

loader = torch.utils.data.DataLoader(
  distorted_dataset, batch_size=128, shuffle=True)
