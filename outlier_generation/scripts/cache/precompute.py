...
batch_size = 100
test_batch_size = 100
model_name = '/afs/cs.wisc.edu/u/x/f/workspace/stable-diffusion/snapshots/energy_ft_sd/in100_wrn_s1_energy_ft_sd_slope_0_weight_1_keep_train_vanilla__epoch_19.pt'
# model_name = '/afs/cs.wisc.edu/u/x/f/workspace/stable-diffusion/snapshots/energy_ft_sd/in100_wrn_s1_energy_ft_sd_slope_0_weight_1_outlier_npos_50_step_epoch_19.pt'
...
trainloader = torch.utils.data.DataLoader(
    torchvision.datasets.ImageFolder(os.path.join('/nobackup-slow/dataset/IN100_new/', 'train'), transform_test_largescale),
    batch_size=test_batch_size, shuffle=True, num_workers=2, pin_memory=True)
val_loader = torch.utils.data.DataLoader(
    torchvision.datasets.ImageFolder(os.path.join('/nobackup-slow/dataset/IN100_new/', 'val'), transform_test_largescale),
    batch_size=test_batch_size, shuffle=True, num_workers=2, pin_memory=True)
