...
if args.dataset == 'CIFAR-10':
    ...
    model.load_state_dict(
        torch.load('/afs/cs.wisc.edu/u/x/f/workspace/ood_theory/pretrained/cifar100_wrn_pretrained_epoch_99.pt'))
    featdim = 128
    ...
    net.load_state_dict(
        torch.load('/afs/cs.wisc.edu/u/x/f/workspace/stable-diffusion/snapshots/energy_ft_sd/cifar100_wrn_s1_energy_ft_sd_slope_0_weight_1.0_sd_clean_vanilla_epoch_199.pt'))
    featdim = 512
...
if args.dataset in {'CIFAR-10', 'CIFAR-100'}:
    ...
    trainset = dataset[args.dataset](root='/nobackup/cifarpy/', train=True, download=True, transform=transform_test)
