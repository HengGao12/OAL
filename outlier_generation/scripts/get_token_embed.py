...
def main():
    ...
    parser.add_argument(
        "--loaded_embedding",
        type=str,
        default='../cifar100_outlier_npos_embed_noise_0.07_select_50_KNN_300.npy'
    )
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--ckpt", type=str, default="/nobackup-slow/dataset/diffusion/sd-v1-4.ckpt", help="path to checkpoint of model")
    # opt = parser.parse_args()
    ...
    'horse chestnut seed', 'coral fungus', 'agaric', 'gyromitra',
    'stinkhorn mushroom', 'earth star fungus', 'hen of the woods mushroom',
    'bolete', 'corn cob', 'toilet paper']  # replace the fine_labels to the corresponding in-distribution class names
    ...
    np.save('../../data/outlier_data/token_embed_in1k.npy', label_embeddings)
