...
test_data = dset.CIFAR100('nobackup-slow/dataset', train=False, transform=test_transform, download=True)
num_classes = 100
...
# net = ResNet18_224x224(num_classes=100).cuda()
net.load_state_dict(torch.load('./snapshots/energy_ft_sd/cifar100_resnet18_s1_energy_ft_sd_slope_0_weight_2.5_samples__epoch_99_final-1-1-1_7_23.pt'))
...
# //////////////CIFAR10 ////////////////
ood_data = dset.CIFAR10('nobackup-slow/dataset/', train=False, transform=test_transform, download=True)
ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.test_bs, shuffle=True,
                                         num_workers=4, pin_memory=True)
print('\n\CIFAR10 Detection')
get_and_print_results(ood_loader)
